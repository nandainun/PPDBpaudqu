              ...
              <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                  <div class="sidebar-brand bg-info">
                    <img src="../<?= $setting['logo_ppdb'] ?>" width="150" alt="PPDB">&nbsp;
                  </div>
                  <div class="menu-header" style="margin-top: 50px;">
                    ...
                    <ul>
                      ...
                      <li>
                        <a class="btn-logout" href="?pg=dataku">
                          <span class="fa fa-user-cog "></span><br>Profil
                        </a>
                      </li>
                      <li>
                        <a href="logout.php" class="btn-logout"> <span class="fa fa-sign-out-alt  "></span><br>Keluar</a>
                      </li>
                    </ul>
                  </div>
